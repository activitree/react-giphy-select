...
var GiphyList = function (_Component) {
  ...
  function GiphyList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = GiphyList.__proto__ || Object.getPrototypeOf(GiphyList)).call.apply(_ref, [this].concat(args))), _this), _this._theme = _extends({
      list: styles.list,
  ...
  _createClass(GiphyList, [{
    ...
    value: function _onWheel(e) {
      ...
      var _scrollbars$getValues = this._scrollbars.getValues(),
          clientHeight = _scrollbars$getValues.clientHeight,
          scrollHeight = _scrollbars$getValues.scrollHeight,
          scrollTop = _scrollbars$getValues.scrollTop;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: items.length ? theme.list : theme.listEmpty, onWheel: this._onWheel.bind(this) },
        _react2.default.createElement(
          _reactCustomScrollbars.Scrollbars,
          { onScrollFrame: this._onScroll.bind(this), renderTrackVertical: function renderTrackVertical() {
          ...
          _react2.default.createElement(
            ...
            items.map(function (entry, index) {
              if (entry.images && entry.images.fixed_width_small && entry.images.fixed_width_small.url) {
                return _react2.default.createElement(
                  'div',
                  { key: '' + index + entry.id, className: theme.listItem },
